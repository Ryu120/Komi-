...
def get_user_list(__init__, key):
    with open("{}/KomiXRyu/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[Komi] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger('[Komi]')
LOGGER.info("Komi is starting. | Built by Ryu. | Licensed under GPLv3.")
LOGGER.info("Yowaimo~ hehe just for fun lol.")
LOGGER.info("Handled by: github.com/Ryu120 (t.me/GojoSenpai)")

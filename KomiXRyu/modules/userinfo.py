...
def info(update: Update, context: CallbackContext):
    ...
    rep = message.reply_text("<code>Let me Find you, waito...</code>", parse_mode=ParseMode.HTML)
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/KomiGotUpdated/3"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/KomiGotUpdated/4")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def set_about_me(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if repl_user_id in [bot.id, 777000, 5327104856] and (user_id in DEV_USERS):
...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_photo(
            ...
            + f"\n\n✦ [Support](https://t.me/{SUPPORT_CHAT}) | ✦ [Updates](https://t.me/Komigotupdated)\n\n"
            + "╘══「[Komi - San](https://t.me/KomiXryu_Bot)」\n",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [ 
                    [ InlineKeyboardButton( 
                        text="Updates", url="https://t.me/KomiGotUpdated") 
                    ] 
                ]
            ),
        )
        ...
        update.effective_message.reply_text(
            (
                ...
                + "╘══「[Komi - San](https://t.me/KomiXryuBot)」\n"
            ),
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup( 
                [
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id in [777000, 5327104856] and sender_id not in DEV_USERS:
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/KomiGotUpdated/3)
"""
